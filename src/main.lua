...
function love.load()
    love.graphics.setNewFont("卷雅花蔓体.ttf",20)
    finishedFont = love.graphics.newFont("卷雅花蔓体.ttf",40)
    love.window.setMode(1024,768,{
        fullscreen = false,
        resizable = false
        })
    love.window.setTitle("LearnForHaapy")
    loadScene("menu")
end
...
function popUpTransitionScreen( deltaPower, deltaHp, starEarned )
        ...
        love.graphics.print("      过关情况 ", 250, 150)
        ...
        love.graphics.print( " 力量增长: "..deltaPower , 300, 330, 0, 0.75)
        love.graphics.print( " 体力消耗: "..deltaHp , 300, 360, 0, 0.75)
        ...
        love.graphics.setColor(0,139,139,200)
        love.graphics.print ( " 下一关 >> ", 340, 475, 0, 0.75, 0.75 )
