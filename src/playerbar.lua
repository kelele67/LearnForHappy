...
function PlayerBar.new(_x, _y, kind)
	local b = {
		x = _x,
		y = _y,
		health = love.graphics.newImage("resource/image/hp_bar.png"),
		power = love.graphics.newImage("resource/image/power_bar.png"),
		bg = love.graphics.newImage("resource/image/full_bg_bar.png"),
		healthQuad = nil,
		powerQuad = nil
	}
